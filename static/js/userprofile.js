        ...
        if (sessionStorage.getItem("pkce_state") != state) {
            ...
            await fetch("https://" + domain + "/oauth2/token?grant_type=authorization_code&client_id=" + appClientId + "&code_verifier=" + code_verifier + "&redirect_uri=" + redirectURI + "&code=" + code, {
                ...
                .then((data) => {
                    ...
                    document.getElementById("access_token_raw").innerHTML = tokens.access_token;
                    document.getElementById("access_token").innerHTML = JSON.stringify(parseJWTPayload(tokens.access_token), null, 3);
                });
            ...
            await fetch("https://" + domain + "/oauth2/userInfo", {
                ...
                .then((data) => {
                    ...
                    document.getElementById("userInfo").innerHTML = JSON.stringify(data, null, 3);
                });
        }
    }
}
